...
<%
    ...
    <div class="d-flex" style="margin-top: 100px !important">
        <a href="#" class="opacity-50 text-decoration-none ms-5 me-2 pe-none">Carrito de compra</a>
        <a href="#" class="opacity-50 text-decoration-none ms-2 me-2 pe-none" aria-disabled="true" tabindex="-1">Datos
            de pago</a>
        <a href="#" class="text-decoration-none ms-2 me-2" aria-disabled="true" tabindex="-1">Confirmación</a>
    </div>
    ...
    <section class="min-vh-100 mt-3">

        <div class="row w-100 ">
            <div class="col-2"></div>
            <div class="form-row align-items-center col-md-5 col-sm-8">
                <form action="inicio_u.jsp" class="form">
                    <div class="col-12 ps-5">
                        <h3 class="mt-5">¡Muchas gracias por su compra!</h3>
                        <div>
                            <p>Agradecemos tu confianza con nosotros, tu pedido se está preparando para ser entregado lo
                                antes posible.
                                Si quieres seguir la información de tu pedido accede al panel de "Mis pedidos". Mientras
                                tanto puedes seguir compando más artículos cuando lo desees.
                            </p>
                        </div>
                        <button type="submit" class="btn btn-secondary mt-3 w-75 ">VOLVER AL INICIO</button>
                    </div>
                </form>

            </div>
            <div class="col-md-3 d-none d-sm-block ms-5">
                <img class="w-100" src="svg/bolsaUno.svg"></img>
            </div>
        </div>
    </section>
