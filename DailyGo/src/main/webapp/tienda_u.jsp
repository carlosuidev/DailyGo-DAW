...
<body>
		...
		<div class="container-fluid p-2">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav">
					<a href="#" class="nav-item nav-link">Tienda</a> <a
	...
	<div id="imagenArriba"
		class="d-flex align-items-end justify-content-center ps-5">
		<h2 class="display-4 text-white pb-3" style="text-shadow: 5px 5px 20px rgba(6, 0, 19, 0.74)" onclick="chanelazo()">Tiendas</h2>
	</div>
				...
				<div class='col-xs-12 col-sm-12 col-md-6 col-lg-4'>
					<form method="POST" action="ServletForm" class='navbar-form'>
						<div class='input-group'>
							<input class='form-control' type='text' name="restauranteNombre"
								id="restauranteNombre" placeholder='Restaurante favorito' /> <span
	...
	<hr class=" me-5 ms-5">
	<a href="suscripciones_u.jsp"><img src="img/Banner_970_90.png"
		class="d-flex justify-content-center w-100 ps-5 pe-5 pt-5 d-none d-sm-block"></a>
	<h2 class="ms-5 mt-5">Restaurantes más buscados por los usuarios</h2>
	<section>
		<div class="row m-5">
			<%
			HttpSession misesion = request.getSession();
			String ListaBuscar = String.valueOf(misesion.getAttribute("ListaBuscar"));
			...
			if (ListaBuscar == null) {
				...
				for (int i = 0; i < lista.size(); i++) {
					...
					out.print("<button type='submit' class='btn w-100 border-none'value='" + lista.get(i).getCif_prov()
					+ "' name='buscarProductoTienda'><img src='" + lista.get(i).getImg_prov()
					+ "' class='w-100  rounded mb-4'/></button>");
					out.print("</form>");
					out.print("</div>");

				}
			} else {
				LinkedList<Proveedores> lista = Controller.listaDeRestaurantes(ListaBuscar);
				for (int i = 0; i < lista.size(); i++) {
					out.println("<div class='col-lg-4 col-md-12 mb-4 mb-lg-0  rounded'>");
					out.println("<form action='ServletForm' method='POST'>");
					out.print("<button type='submit' class='btn w-100 border-none' value='" + lista.get(i).getCif_prov()
					...
					<div class="col-lg-3 col-md-6 mb-4 mb-md-0 pt-4 ps-5">
						...
						<ul class="list-unstyled">
							...
							<li class="mb-2"><a href="sobre_nosotros.html"
								class="text-white text-decoration-none">Sobre nosotros</a></li>
						</ul>
					</div>
	...
	<script type="text/javascript" src="Chanelazo.js">
