...
<body class="font-medium text-blue-800 pb-36">
    ...
    <div class="hover:shadow-lg duration-300 border border-b-0 border-x-0 border-t-1 border-white fixed lg:flex md:flex hidden bottom-0 w-full bg-blue-800 text-white p-2 z-50"
        id="contadorPedidos">
        <div class="container mx-auto py-3 flex justify-between items-center gap-8 flex-shrink-0">
            <div class="flex flex justify-start w-full gap-5 overflow-x-auto" id="listProductosBar">
                <div class="shrink-0 bg-blue-700 rounded-md p-2">
                    <p class="text-sm">Big Mac</p>
                    <p class="text-sm font-normal text-blue-300"><span>1 ud.</span> | <span>3,75€</span></p>
                </div>
                <div class="shrink-0 bg-blue-700 rounded-md p-2">
                    <p class="text-sm">Patatas</p>
                    <p class="text-sm font-normal text-blue-300"><span>1 ud.</span> | <span>1,00€</span></p>
                </div>
                <div class="shrink-0 bg-blue-700 rounded-md p-2">
                    <p class="text-sm">McFlurry Oreo</p>
                    <p class="text-sm font-normal text-blue-300"><span>2 ud.</span> | <span>6,82€</span></p>
                </div>
            </div>
            ...
            <a href="carrito.html"
                class="shrink-0 bg-yellow-400 text-blue-800 font-bold hover:bg-yellow-500 duration-300 rounded px-3 py-4">Revisar
                pedido</a>
        </div>
    </div>
    ...
    <a href="carrito.html"
        ...
        <div class="flex items-center bg-yellow-400 rounded-full">
            <div class="rounded-full w-12 h-12 bg-white flex items-center justify-center">
                ...
                <p class="absolute text-sm mt-1.5 font-bold">2</p>
            </div>
    ...
    <section class="mt-10 lg:mt-18 md:mt-16 p-5 lg:p-3 md:p-5">
        <div class="container mx-auto flex flex-col items-center">
            <div class="text-center items-center">
                ...
                <p class="px-0 lg:px-64 md:px-5 mt-5">Encuentra tus restaurantes favoritos con los descuentos más
