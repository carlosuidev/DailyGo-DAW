...
try {
    ...
    if (isset($cif)) {
        ...
        WHERE proveedores.cif_prov = \"$cif\"
        AND (ventas.estado_ven='Creado' OR ventas.estado_ven='En preparación' OR ventas.estado_ven='Preparado') ORDER BY ventas.num_ven DESC");
    } else {
