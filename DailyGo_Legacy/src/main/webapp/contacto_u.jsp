...
<head>
    ...
    <link rel="stylesheet" href="css/landing_page_u.css">
...
<%
    ...
    <section class="min-vh-100 ps-5 pe-5" style="margin-top: 100px !important; margin-bottom: 200px;">
        <h2>Contacto</h2>
        <hr>
        <div class="row mt-5">
            <div class="col-md-5 col-sm-12">
                <h6 class="text-secondary">INFORMACIÓN Y AYUDA</h6>
                <h3>CONTACTA CON NOSOTROS</h3>
                <p class="mt-4 ms-5"><img src="svg/fi-ss-call-incoming.svg" class="me-3"> +34 655 55 55 55</p>
                <p class="mt-4 ms-5"><img src="svg/fi-ss-envelope.svg" class="me-3"> hello@dailygo.com</p>
                <p class="mt-4 ms-5"><img src="svg/fi-ss-home-location-alt.svg" class="me-3"> C/ Diario, 5</p>
            </div>
            <div class="col-md-6 bg-white border-1 shadow rounded ps-5 pe-5 pb-3 pt-3">
                <form action="ServletForm" method="POST"class="form mt-3">
                    <div class="form-group mb-2">
                        <label class="mb-2" for="motivoU">Motivo</label>
                        <input type="text" name="motivoU" id="motivoU" class="form-control"
                            placeholder="Inserte un motivo" required>
                    </div>
                    <div class="form-group mb-2">
                        <label class="mb-2" for="descU">Descripción</label>
                        <textarea style="min-height: 150px" type="text" name="descU" id="descU" class="form-control"
                            placeholder="Inserte una descripción del motivo" required></textarea>
                    <button type="submit" class=" mt-3 btn btn-secondary w-100">ENVIAR</button>
                    </div>
                </form>
            </div>
        </div>
