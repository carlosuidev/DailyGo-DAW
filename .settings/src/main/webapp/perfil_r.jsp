...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top ps-5 pe-5">
        <div class="container-fluid p-2">
            <a href="inicio_r.html" class="navbar-brand">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="navbar-nav ms-auto">
                    <a href="inicio_r.html" class="nav-item nav-link">
    ...
    <section class="ps-5 pe-5 w-100 mb-5 min-vh-100" style="margin-top: 100px !important">
                    ...
                    <div class="modal-body">
                        <form class="was-validated" method="POST" action="ServletForm">
                            ...
                            <div class="d-flex mt-4">
                                <button type="submit" class="btn btn-success text-white w-50 me-3">GUARDAR CAMBIOS</button>
                                <button type="button" class="btn btn-danger text-white w-50">BORRAR CUENTA</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="bg-white shadow-lg mb-5 p-4 row">
            <div class="col mb-3">
                <img src="img/Dunkin.png" class="rounded-circle" width="64" height="64">
            </div>
            <%
            ...
            <div class="col">
                ...
                <a href="#">
                    <img src="svg/salir.svg" alt="Borrar Cuenta">
                </a>
            </div>
        </div>
                ...
                <div class="row my-5">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0 pt-4 ps-5">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a href="inicio_r.html" class="text-white  text-decoration-none">Inicio</a>
                            </li>
                            <li class="mb-2">
                                <a href="perfil_r.html" class="text-white text-decoration-none">Perfil</a>
                            </li>
                            <li class="mb-2">
